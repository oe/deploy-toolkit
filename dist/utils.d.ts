 ...
 */
export declare function runCmd(cmd: string, options?: SpawnOptions): Promise<string>;
export declare function runCmd(cmd: string, args?: string[], options?: SpawnOptions): Promise<string>;
/**
 ...
 */
export declare function findFileRecursive(fileName: string, dir?: string, isDir?: boolean): any;
/** add tag for git, use `v${package.version}` in package.json as tagName by default  */
export declare function addGitTag(tagName?: string): Promise<void>;
